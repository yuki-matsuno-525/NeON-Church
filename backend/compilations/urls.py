...
urlpatterns = [
    ...
    path("compilations/<uuid:book_id>/chapters/reorder/", views.CompiledChapterReorderView.as_view(), name="compiled-chapter-reorder"),
    ...
    path("compilations/<uuid:book_id>/verses/reorder/", views.CompiledVerseReorderView.as_view(), name="compiled-verse-reorder"),
    path("compilations/<uuid:book_id>/verses/bulk/", views.CompiledVerseBulkCreateView.as_view(), name="compiled-verse-bulk-create"),
