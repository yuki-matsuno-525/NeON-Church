...
INDEXES = [('articles_title_trgm_idx', 'articles', 'title'),
    ('articles_summary_trgm_idx', 'articles', 'summary'),
    ('articles_body_trgm_idx', 'articles', 'body')]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("articles", "0003_drop_compilations"),
    ]
