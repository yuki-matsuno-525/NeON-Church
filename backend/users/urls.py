...
urlpatterns = [
    ...
    path("settings/preferences/", views.NotificationPreferencesView.as_view(), name="account-preferences"),
    ...
    path("settings/sessions/revoke-others/", views.RevokeOtherSessionsView.as_view(), name="account-sessions-revoke-others"),
    path("settings/sessions/<str:jti>/", views.SessionRevokeView.as_view(), name="account-session-revoke"),
