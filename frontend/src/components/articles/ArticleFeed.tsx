 ...
 * 「もっと見る」で続きを読み足すところだけ。
 */
export function ArticleFeed({ empty, editable = false, mine, tag, book, q, initial }: Props) {
  const fetchPage = useCallback(
    (page: number) => fetchArticlePage({ mine, tag, book, q, page }),
    [mine, tag, book, q],
  );
