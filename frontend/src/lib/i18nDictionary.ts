...
const ja = {
  ...
  // 解釈書（教父・ラシ・カルヴァン・無教会など）
  commentary: "解釈書",
  commentaryDesc: "教父、ユダヤ教、宗教改革、無教会。聖書がどう読まれてきたかを、時代と立場をまたいでたどる。",
  tabCommentary: (n: number) => `解釈 (${n})`,
  commentaryNoneHere: "この節を直接論じた解釈はありません。",
  commentaryBroadTitle: "章・書全体についての解釈",
  commentaryMentions: (n: number) => `この節に触れている箇所 (${n})`,
  commentaryReadFull: "全文を読む",
  commentaryMethods: { structure: "節ごとの注解", citation: "引用", ai: "AI判定" } as Record<string, string>,
  commentaryAiNote: (percent: number) => `AIが推定した結び付きです（確からしさ ${percent}%）`,
  commentaryTraditions: {
    jewish: "ユダヤ教", patristic: "教父", medieval: "中世", reformation: "宗教改革", mukyokai: "無教会",
  } as Record<string, string>,
  commentaryLanguages: { en: "英語", ja: "日本語" } as Record<string, string>,
  commentaryYear: (year: number) => `${year}年ごろ`,
  commentarySource: "出典",
  commentaryTranslator: "英訳",
  commentaryLicense: "権利",
  commentaryLicenses: {
    "public-domain": "パブリックドメイン", cc0: "CC0", "cc-by": "CC BY", "cc-by-sa": "CC BY-SA", "cc-by-nc": "CC BY-NC",
  } as Record<string, string>,
  commentaryExcerptsNote: "節ごとの注解を集めた抜粋集です。聖書の順に並んでいます。",
  commentarySectionCount: (n: number) => `${n.toLocaleString()} の区切り`,
  commentaryDiscussedPassages: "論じている箇所",
  commentaryCitedPassages: "引いている箇所",
  commentaryBackToList: "解釈書の一覧へ",
  commentaryEmpty: "解釈書はまだありません。",
  commentaryLoadEarlier: "↑ 前の区切りを読む",
  commentarySelectChapter: "章を選ぶ",
  commentaryFindWork: "解釈書を名前・著者で絞る",
  readTabBible: "聖書",
  readTabsLabel: "読むものの切り替え",
  ...
  // 自動保存の案内。編集画面（記事・プラン）の「使い方」の最後に添える。
  autosaveNotice: "書いた内容は自動で保存されます。題の横に「保存済み ✓」と出ていれば保存できています。",
  // 編集画面の上に置く、たためる「使い方」（HowToGuide）。
  planGuideTitle: "プランの作り方",
  planGuideSteps: [
    "「＋ 日を足す」で、第1日・第2日…と日を増やします。",
    "日を開いて「章を追加」から、その日に読む章を選びます。正典と外典をまたいで並べられます。",
    "日の題や、その日に添える文章は書かなくてもかまいません。",
    "すべての日に章が入ったら、題の横の「下書き」を「公開」に変えます。公開すると、誰でも読めて一覧にも出ます。",
  ],
  articleGuideTitle: "記事の書き方",
  articleGuideSteps: [
    "要約を書きます。一覧に出る短い説明で、公開するときに必要です。",
    "本文を書きます。聖書の箇所は、引用パネルから選んで入れられます。",
    "主題を選ぶと、同じ主題の記事と一緒に見つけてもらえます。",
    "書き終えたら、題の横の「下書き」を「公開」に変えます。公開すると、誰でも読めて一覧にも出ます。",
  ],
  ...
  homeStartReading: "登録せずに読んでみる",
  homeAboutLink: "NeON Church とは",
  homeNoSignup: "読むだけなら登録は要りません。",
  homeWelcome: "信仰のある人も、探している人も、研究として読む人も歓迎します。",
  homeFirstBooks: "初めてなら、この3冊から",
  homeFirstBookJohn: "「はじめに言があった」から始まる福音書",
  homeFirstBookMark: "いちばん短く、テンポの速い福音書",
  homeFirstBookThomas: "聖書に入らなかった、イエスの語録",
  homeMoreSections: "そのほかの入口",
  todayVerse: "今日の聖句",
  ...
  // 一覧の絞り込み。検索欄はいつも出し、それ以外はこのボタンの中に置く。
  filterToggle: "絞り込み",
  allLanguages: "すべての言語",
  projectCount: (n: number) => `${n}件`,
  articleSearchLabel: "記事を検索",
  articleCount: (n: number) => `${n}件`,
  planSearchLabel: "プランを検索",
  planCount: (n: number) => `${n}件`,
  planDaysFilterLabel: "日数で絞り込む",
  planDaysAll: "すべての日数",
  planDaysShort: "〜7日",
  planDaysMid: "8〜30日",
  planDaysLong: "31日以上",
...
const en: typeof ja = {
  ...
  commentaryDesc: "Church Fathers, Jewish sages, Reformers, and the Mukyokai movement: how the texts have been read across eras and traditions.",
  tabCommentary: (n: number) => `Commentary (${n})`,
  commentaryNoneHere: "No commentary discusses this verse directly.",
  commentaryBroadTitle: "On the whole chapter or book",
  commentaryMentions: (n: number) => `Passages that mention this verse (${n})`,
  commentaryReadFull: "Read in full",
  commentaryMethods: { structure: "Verse commentary", citation: "Citation", ai: "AI-identified" } as Record<string, string>,
  commentaryAiNote: (percent: number) => `This link was identified by AI (confidence ${percent}%)`,
  commentaryTraditions: {
    jewish: "Jewish", patristic: "Church Fathers", medieval: "Medieval", reformation: "Reformation", mukyokai: "Mukyokai",
  } as Record<string, string>,
  commentaryLanguages: { en: "English", ja: "Japanese" } as Record<string, string>,
  commentaryYear: (year: number) => `c. ${year}`,
  commentarySource: "Source",
  commentaryTranslator: "Translation",
  commentaryLicense: "License",
  commentaryLicenses: {
    "public-domain": "Public domain", cc0: "CC0", "cc-by": "CC BY", "cc-by-sa": "CC BY-SA", "cc-by-nc": "CC BY-NC",
  } as Record<string, string>,
  commentaryExcerptsNote: "A collection of verse-by-verse excerpts, arranged in biblical order.",
  commentarySectionCount: (n: number) => `${n.toLocaleString()} sections`,
  commentaryDiscussedPassages: "Discusses",
  commentaryCitedPassages: "Cites",
  commentaryBackToList: "All commentaries",
  commentaryEmpty: "No commentaries yet.",
  ...
  planPickBible: "Bible",
  citationCommentaryTab: "Commentaries",
  ...
  articleAllTopicsOption: "All topics",
  ...
  autosaveNotice: "Your changes are saved automatically. If you see \"Saved ✓\" next to the title, they're saved.",
  planGuideTitle: "How to build a plan",
  planGuideSteps: [
    "Use \"+ Add a day\" to add Day 1, Day 2, and so on.",
    "Open a day and pick its chapters under \"Add chapters\". You can mix canonical and apocryphal books.",
    "A title and text for each day are optional.",
    "Once every day has chapters, change \"Draft\" next to the title to \"Public\". Public plans can be read by anyone and appear in lists.",
  ],
  articleGuideTitle: "How to write an article",
  articleGuideSteps: [
    "Write a summary. It's the short description shown in lists, and it's required to publish.",
    "Write the body. You can insert Bible passages from the citation panel.",
    "Choose topics so readers can find it alongside related articles.",
    "When you're done, change \"Draft\" next to the title to \"Public\". Public articles can be read by anyone and appear in lists.",
  ],
  ...
  homeStartReading: "Start reading, no sign-up",
  homeAboutLink: "About NeON Church",
  homeNoSignup: "You don't need an account to read.",
  homeWelcome: "Believers, seekers, and scholars are all welcome.",
  homeFirstBooks: "New here? Start with one of these",
  homeFirstBookJohn: "The Gospel that opens with \"In the beginning was the Word\"",
  homeFirstBookMark: "The shortest, fastest-moving Gospel",
  homeFirstBookThomas: "Sayings of Jesus that were left out of the Bible",
  homeMoreSections: "More to explore",
  ...
  projectCount: (n: number) => `${n} results`,
  articleSearchLabel: "Search articles",
  articleCount: (n: number) => `${n} results`,
  planSearchLabel: "Search plans",
  planCount: (n: number) => `${n} results`,
  planDaysFilterLabel: "Filter by length",
  planDaysAll: "Any length",
  planDaysShort: "Up to 7 days",
  planDaysMid: "8–30 days",
  planDaysLong: "31+ days",
  planSortLabel: "Sort",
  planSortNew: "Newest",
  planSortPopular: "Most readers",
  ...
  bookmarkKindCommentary: "Commentary",
