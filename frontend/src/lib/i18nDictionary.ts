...
const ja = {
  ...
  articleAutosaveHelp: "変更は自動保存されます。移動前には未保存分を保存します。",
...
const en: typeof ja = {
  ...
  articleAutosaveHelp: "Changes are saved automatically, including before you leave.",
