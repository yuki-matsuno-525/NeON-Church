...
import { commentaryLinkHref, commentaryLinkLabel, commentarySectionHref } from "./commentary";
...
describe("解釈書の箇所の書き方", () => {
  ...
  it("読書画面と解釈書ページへのリンク", () => {
    ...
    expect(commentarySectionHref("calvin-commentaries", 12)).toBe("/commentary/calvin-commentaries?around=12#s-12");
  });
});
