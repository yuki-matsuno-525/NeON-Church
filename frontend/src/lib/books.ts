...
export const BOOKS = [
  ...
  { slug: "genesis", name: "創世記", englishName: "Genesis", short: "創世記", totalChapters: 50, genre: "律法" as BookGenre,
    translations: [{ id: "KJV", name: "Genesis" }, { id: "文語訳", name: "創世記" }, { id: "WLC (HEB)", name: "בְּרֵאשִׁית" }, { id: "LXX (GRC)", name: "Γένεση" }] },
  { slug: "exodus", name: "出エジプト記", englishName: "Exodus", short: "出エジプト", totalChapters: 40, genre: "律法" as BookGenre,
    translations: [{ id: "KJV", name: "Exodus" }, { id: "文語訳", name: "出埃及記" }, { id: "WLC (HEB)", name: "שְׁמוֹת" }, { id: "LXX (GRC)", name: "Έξοδος" }] },
  { slug: "leviticus", name: "レビ記", englishName: "Leviticus", short: "レビ", totalChapters: 27, genre: "律法" as BookGenre,
    translations: [{ id: "KJV", name: "Leviticus" }, { id: "文語訳", name: "利未記" }, { id: "WLC (HEB)", name: "וַיִּקְרָא" }, { id: "LXX (GRC)", name: "Λευιτικόν" }] },
  { slug: "numbers", name: "民数記", englishName: "Numbers", short: "民数", totalChapters: 36, genre: "律法" as BookGenre,
    translations: [{ id: "KJV", name: "Numbers" }, { id: "文語訳", name: "民數紀略" }, { id: "WLC (HEB)", name: "בְּמִדְבַּר" }, { id: "LXX (GRC)", name: "Αριθμοί" }] },
  { slug: "deuteronomy", name: "申命記", englishName: "Deuteronomy", short: "申命", totalChapters: 34, genre: "律法" as BookGenre,
    translations: [{ id: "KJV", name: "Deuteronomy" }, { id: "文語訳", name: "申命記" }, { id: "WLC (HEB)", name: "דְּבָרִים" }, { id: "LXX (GRC)", name: "Δευτερονόμιον" }] },
  { slug: "joshua", name: "ヨシュア記", englishName: "Joshua", short: "ヨシュア", totalChapters: 24, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Joshua" }, { id: "文語訳", name: "約書亞記" }, { id: "WLC (HEB)", name: "יְהוֹשֻׁעַ" }, { id: "LXX (GRC)", name: "Ἰησοῦς Nαυῆ" }] },
  { slug: "judges", name: "士師記", englishName: "Judges", short: "士師", totalChapters: 21, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Judges" }, { id: "文語訳", name: "士師記" }, { id: "WLC (HEB)", name: "שׁוֹפְטִים" }, { id: "LXX (GRC)", name: "Κριταί" }] },
  { slug: "ruth", name: "ルツ記", englishName: "Ruth", short: "ルツ", totalChapters: 4, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Ruth" }, { id: "文語訳", name: "路得記" }, { id: "WLC (HEB)", name: "רוּת" }, { id: "LXX (GRC)", name: "Ῥούθ" }] },
  { slug: "1-samuel", name: "サムエル記上", englishName: "1 Samuel", short: "サムエル上", totalChapters: 31, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "1 Samuel" }, { id: "文語訳", name: "撒母耳前書" }, { id: "WLC (HEB)", name: "שְׁמוּאֵל א" }, { id: "LXX (GRC)", name: "1η Σαμουήλ" }] },
  { slug: "2-samuel", name: "サムエル記下", englishName: "2 Samuel", short: "サムエル下", totalChapters: 24, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "2 Samuel" }, { id: "文語訳", name: "撒母耳後書" }, { id: "WLC (HEB)", name: "שְׁמוּאֵל ב" }, { id: "LXX (GRC)", name: "2η Σαμουήλ" }] },
  { slug: "1-kings", name: "列王紀上", englishName: "1 Kings", short: "列王上", totalChapters: 22, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "1 Kings" }, { id: "文語訳", name: "列王紀略上" }, { id: "WLC (HEB)", name: "מְלָכִים א" }, { id: "LXX (GRC)", name: "Βασιλειῶν Γʹ" }] },
  { slug: "2-kings", name: "列王紀下", englishName: "2 Kings", short: "列王下", totalChapters: 25, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "2 Kings" }, { id: "文語訳", name: "列王紀略下" }, { id: "WLC (HEB)", name: "מְלָכִים ב" }, { id: "LXX (GRC)", name: "Βασιλειῶν Δʹ" }] },
  { slug: "1-chronicles", name: "歴代志上", englishName: "1 Chronicles", short: "歴代上", totalChapters: 29, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "1 Chronicles" }, { id: "文語訳", name: "歴代志略上" }, { id: "WLC (HEB)", name: "דִּבְרֵי הַיָּמִים א" }, { id: "LXX (GRC)", name: "1η Χρονικών" }] },
  { slug: "2-chronicles", name: "歴代志下", englishName: "2 Chronicles", short: "歴代下", totalChapters: 36, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "2 Chronicles" }, { id: "文語訳", name: "歴代志略下" }, { id: "WLC (HEB)", name: "דִּבְרֵי הַיָּמִים ב" }, { id: "LXX (GRC)", name: "2η Χρονικών" }] },
  { slug: "ezra", name: "エズラ記", englishName: "Ezra", short: "エズラ", totalChapters: 10, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Ezra" }, { id: "文語訳", name: "エズラ書" }, { id: "WLC (HEB)", name: "עֶזְרָא" }, { id: "LXX (GRC)", name: "Ἔσδρας" }] },
  { slug: "nehemiah", name: "ネヘミヤ記", englishName: "Nehemiah", short: "ネヘミヤ", totalChapters: 13, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Nehemiah" }, { id: "文語訳", name: "尼希米亞記" }, { id: "WLC (HEB)", name: "נְחֶמְיָה" }, { id: "LXX (GRC)", name: "Νεεμίας" }] },
  { slug: "esther", name: "エステル記", englishName: "Esther", short: "エステル", totalChapters: 10, genre: "歴史" as BookGenre,
    translations: [{ id: "KJV", name: "Esther" }, { id: "文語訳", name: "以士帖書" }, { id: "WLC (HEB)", name: "אֶסְתֵּר" }, { id: "LXX (GRC)", name: "Ἐσθήρ" }] },
  { slug: "job", name: "ヨブ記", englishName: "Job", short: "ヨブ", totalChapters: 42, genre: "詩歌" as BookGenre,
    translations: [{ id: "KJV", name: "Job" }, { id: "文語訳", name: "ヨブ記" }, { id: "WLC (HEB)", name: "אִיּוֹב" }, { id: "LXX (GRC)", name: "Ἰώβ" }] },
  { slug: "psalms", name: "詩篇", englishName: "Psalms", short: "詩篇", totalChapters: 150, genre: "詩歌" as BookGenre,
    translations: [{ id: "KJV", name: "Psalms" }, { id: "文語訳", name: "詩篇" }, { id: "WLC (HEB)", name: "תְּהִלִּים" }, { id: "LXX (GRC)", name: "Ψαλμοί" }] },
  { slug: "proverbs", name: "箴言", englishName: "Proverbs", short: "箴言", totalChapters: 31, genre: "詩歌" as BookGenre,
    translations: [{ id: "KJV", name: "Proverbs" }, { id: "文語訳", name: "箴言" }, { id: "WLC (HEB)", name: "מִשְׁלֵי" }, { id: "LXX (GRC)", name: "Παροιμίαι" }] },
  { slug: "ecclesiastes", name: "伝道の書", englishName: "Ecclesiastes", short: "伝道", totalChapters: 12, genre: "詩歌" as BookGenre,
    translations: [{ id: "KJV", name: "Ecclesiastes" }, { id: "文語訳", name: "傳道之書" }, { id: "WLC (HEB)", name: "קֹהֶלֶת" }, { id: "LXX (GRC)", name: "Ἐκκλησιαστής" }] },
  { slug: "song-of-songs", name: "雅歌", englishName: "Song of Solomon", short: "雅歌", totalChapters: 8, genre: "詩歌" as BookGenre,
    translations: [{ id: "KJV", name: "Song of Solomon" }, { id: "文語訳", name: "雅歌" }, { id: "WLC (HEB)", name: "שִׁיר הַשִּׁירִים" }, { id: "LXX (GRC)", name: "Ἆσμα Ἀσμάτων" }] },
  { slug: "isaiah", name: "イザヤ書", englishName: "Isaiah", short: "イザヤ", totalChapters: 66, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Isaiah" }, { id: "文語訳", name: "以賽亞書" }, { id: "WLC (HEB)", name: "יְשַׁעְיָהוּ" }, { id: "LXX (GRC)", name: "Ἠσαΐας" }] },
  { slug: "jeremiah", name: "エレミヤ書", englishName: "Jeremiah", short: "エレミヤ", totalChapters: 52, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Jeremiah" }, { id: "文語訳", name: "耶利米亞記" }, { id: "WLC (HEB)", name: "יִרְמְיָהוּ" }, { id: "LXX (GRC)", name: "Ἱερεμίας" }] },
  { slug: "lamentations", name: "哀歌", englishName: "Lamentations", short: "哀歌", totalChapters: 5, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Lamentations" }, { id: "文語訳", name: "耶利米亞哀歌" }, { id: "WLC (HEB)", name: "אֵיכָה" }, { id: "LXX (GRC)", name: "Θρήνοι" }] },
  { slug: "ezekiel", name: "エゼキエル書", englishName: "Ezekiel", short: "エゼキエル", totalChapters: 48, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Ezekiel" }, { id: "文語訳", name: "以西結書" }, { id: "WLC (HEB)", name: "יְחֶזְקֵאל" }, { id: "LXX (GRC)", name: "Ἰεζεκιήλ" }] },
  { slug: "daniel", name: "ダニエル書", englishName: "Daniel", short: "ダニエル", totalChapters: 12, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Daniel" }, { id: "文語訳", name: "但以理書" }, { id: "WLC (HEB)", name: "דָּנִיֵּאל" }, { id: "LXX (GRC)", name: "Δανιήλ" }] },
  { slug: "hosea", name: "ホセア書", englishName: "Hosea", short: "ホセア", totalChapters: 14, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Hosea" }, { id: "文語訳", name: "何西阿書" }, { id: "WLC (HEB)", name: "הוֹשֵׁעַ" }, { id: "LXX (GRC)", name: "Ὡσηέ" }] },
  { slug: "joel", name: "ヨエル書", englishName: "Joel", short: "ヨエル", totalChapters: 3, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Joel" }, { id: "文語訳", name: "約耳書" }, { id: "WLC (HEB)", name: "יוֹאֵל" }, { id: "LXX (GRC)", name: "Ἰωήλ" }] },
  { slug: "amos", name: "アモス書", englishName: "Amos", short: "アモス", totalChapters: 9, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Amos" }, { id: "文語訳", name: "亞麽士書" }, { id: "WLC (HEB)", name: "עָמוֹס" }, { id: "LXX (GRC)", name: "Ἀμώς" }] },
  { slug: "obadiah", name: "オバデヤ書", englishName: "Obadiah", short: "オバデヤ", totalChapters: 1, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Obadiah" }, { id: "文語訳", name: "阿巴底亞書" }, { id: "WLC (HEB)", name: "עֹבַדְיָה" }, { id: "LXX (GRC)", name: "Οβαδια" }] },
  { slug: "jonah", name: "ヨナ書", englishName: "Jonah", short: "ヨナ", totalChapters: 4, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Jonah" }, { id: "文語訳", name: "約拿書" }, { id: "WLC (HEB)", name: "יוֹנָה" }, { id: "LXX (GRC)", name: "Ιώνας" }] },
  { slug: "micah", name: "ミカ書", englishName: "Micah", short: "ミカ", totalChapters: 7, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Micah" }, { id: "文語訳", name: "米迦書" }, { id: "WLC (HEB)", name: "מִיכָה" }, { id: "LXX (GRC)", name: "Μιχαίας" }] },
  { slug: "nahum", name: "ナホム書", englishName: "Nahum", short: "ナホム", totalChapters: 3, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Nahum" }, { id: "文語訳", name: "拿翁書" }, { id: "WLC (HEB)", name: "נַחוּם" }, { id: "LXX (GRC)", name: "Ναούμ" }] },
  { slug: "habakkuk", name: "ハバクク書", englishName: "Habakkuk", short: "ハバクク", totalChapters: 3, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Habakkuk" }, { id: "文語訳", name: "哈巴谷書" }, { id: "WLC (HEB)", name: "חֲבַקּוּק" }, { id: "LXX (GRC)", name: "Ἀββακούμ" }] },
  { slug: "zephaniah", name: "ゼパニヤ書", englishName: "Zephaniah", short: "ゼパニヤ", totalChapters: 3, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Zephaniah" }, { id: "文語訳", name: "西番雅書" }, { id: "WLC (HEB)", name: "צְפַנְיָה" }, { id: "LXX (GRC)", name: "Σοφονίας" }] },
  { slug: "haggai", name: "ハガイ書", englishName: "Haggai", short: "ハガイ", totalChapters: 2, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Haggai" }, { id: "文語訳", name: "哈基書" }, { id: "WLC (HEB)", name: "חַגַּי" }, { id: "LXX (GRC)", name: "Ἀγγαῖος" }] },
  { slug: "zechariah", name: "ゼカリヤ書", englishName: "Zechariah", short: "ゼカリヤ", totalChapters: 14, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Zechariah" }, { id: "文語訳", name: "撒加利亞書" }, { id: "WLC (HEB)", name: "זְכַרְיָה" }, { id: "LXX (GRC)", name: "Ζαχαρίας" }] },
  { slug: "malachi", name: "マラキ書", englishName: "Malachi", short: "マラキ", totalChapters: 4, genre: "預言" as BookGenre,
    translations: [{ id: "KJV", name: "Malachi" }, { id: "文語訳", name: "馬拉基書" }, { id: "WLC (HEB)", name: "מַלְאָכִי" }, { id: "LXX (GRC)", name: "Μαλαχίας" }] },
  { slug: "acts", name: "使徒行伝", englishName: "Acts", short: "使徒", totalChapters: 28, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Acts" }, { id: "TR (GRC)", name: "Πραξεις Των Αποστολων" }, { id: "文語訳", name: "使徒行傳" }] },
  { slug: "romans", name: "ローマ人への手紙", englishName: "Romans", short: "ローマ", totalChapters: 16, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Romans" }, { id: "TR (GRC)", name: "Προς Ρωμαιους" }, { id: "文語訳", name: "ロマ人への書" }] },
  { slug: "1-corinthians", name: "コリント人への第一の手紙", englishName: "1 Corinthians", short: "Iコリント", totalChapters: 16, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "1 Corinthians" }, { id: "TR (GRC)", name: "Προς κορινθιους Α΄" }, { id: "文語訳", name: "コリント人への前の書" }] },
  { slug: "2-corinthians", name: "コリント人への第二の手紙", englishName: "2 Corinthians", short: "IIコリント", totalChapters: 13, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "2 Corinthians" }, { id: "TR (GRC)", name: "Προς κορινθιους Β΄" }, { id: "文語訳", name: "コリント人への後の書" }] },
  { slug: "galatians", name: "ガラテヤ人への手紙", englishName: "Galatians", short: "ガラテヤ", totalChapters: 6, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Galatians" }, { id: "TR (GRC)", name: "Προς Γαλατας" }, { id: "文語訳", name: "ガラテヤ人への書" }] },
  { slug: "ephesians", name: "エペソ人への手紙", englishName: "Ephesians", short: "エペソ", totalChapters: 6, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Ephesians" }, { id: "TR (GRC)", name: "Προς Εφεσιους" }, { id: "文語訳", name: "エペソ人への書" }] },
  { slug: "philippians", name: "ピリピ人への手紙", englishName: "Philippians", short: "ピリピ", totalChapters: 4, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Philippians" }, { id: "TR (GRC)", name: "Προς Φιλιππησιους" }, { id: "文語訳", name: "ピリピ人への書" }] },
  { slug: "colossians", name: "コロサイ人への手紙", englishName: "Colossians", short: "コロサイ", totalChapters: 4, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "Colossians" }, { id: "TR (GRC)", name: "Προς Κολοσσαεις" }, { id: "文語訳", name: "コロサイ人への書" }] },
  { slug: "1-thessalonians", name: "テサロニケ人への第一の手紙", englishName: "1 Thessalonians", short: "Iテサロニケ", totalChapters: 5, genre: "使徒・書簡" as BookGenre,
    translations: [{ id: "KJV", name: "1 Thessalonians" }, { id: "TR (GRC)", name: "Προς Θεσσαλονικεις Α΄" }, { id: "文語訳", name: "テサロニケ人への前の書" }] },
