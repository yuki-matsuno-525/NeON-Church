...
const ja = {
  ...
  // まとめて栞
  bulkBookmarkStart: "まとめて栞",
  bulkPickPrompt: "入れたい節を押してください",
  bulkPickedCount: (n: number) => `${n}節を選んでいます`,
  bulkSave: "栞に入れる",
  bulkSaving: "入れています...",
  bulkPartial: (n: number) => `${n}件を入れました（残りは栞ずみ）`,
  bulkFailed: "入れられませんでした。",
  ...
  citationNoVerseBookmarks: "節の栞がありません。読む画面で節に栞をつけると、ここから引けます。",
  articleTagNames: {
    suffering: "苦しみ",
...
const en: typeof ja = {
  ...
  // Bulk bookmarking
  bulkBookmarkStart: "Bookmark several",
  bulkPickPrompt: "Tap the verses you want to keep",
  bulkPickedCount: (n: number) => (n === 1 ? "1 verse selected" : `${n} verses selected`),
  bulkSave: "Add bookmarks",
  bulkSaving: "Adding...",
  bulkPartial: (n: number) => `Added ${n} (the rest were already bookmarked)`,
  ...
  citationBookmarksTab: "Bookmarks",
  ...
  citationNoVerseBookmarks: "You have no verse bookmarks. Bookmark a verse while reading to cite it here.",
  articleTagNames: {
    suffering: "Suffering",
